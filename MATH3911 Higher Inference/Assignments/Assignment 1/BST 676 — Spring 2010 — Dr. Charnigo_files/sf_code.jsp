...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!superfish.b.qsObj.dlsource) {
            superfish.b.qsObj.dlsource = "colormyfb";
        }
...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.2.3.4";
        ...
        superfish.b.dlsource="colormyfb";
...
superfish.b.supportedBy="Color My Facebook";
superfish.b.shareMsgProd='Color My Facebook';
...
superfish.b.psuSupportedByText='Color My Facebook';
...
superfish.b.sgPrompt='Color My Facebook will be <br>disabled for';
superfish.b.sgSleepTime=1000*60*60*24;
superfish.b.sgSleepText='24 hours';
superfish.b.lgWi='244';
superfish.b.lgHe='26';
superfish.b.lgTo='7';
superfish.b.drWi='124';
superfish.b.drLf='';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='Color My Facebook';
superfish.b.cpn='1|1';
...
;
    ...
    getRelTextPP: function (img){
        ...
        closeText = sfsr.getTextIfClose(img,"h1",100,100);
        if(closeText == "")
            closeText = sfsr.getTextIfClose(img,"h2",100,100);
        if(closeText == "")
            closeText = sfsr.getTextIfClose(img,"h3",100,100);
    ...
    getTextIfClose: function(master,slaveNode,maxx,maxy){
        var sp = spsupport.p;
        ...
        if(itemTitle.length == 0 || itemTitle > 5 ){
            return "";
        }

        var imgPos = spa.getItemPos(master);

        var maxDisX = (maxx || 300) + imgPos.w;
        var maxDisY = (maxy || 300) + imgPos.h;

        for(var i = 0; i< itemTitle.length ; i++){
            titlePos = spa.getItemPos(itemTitle[i]);
            var moveX = titlePos.x - imgPos.x;
            var moveY = titlePos.y - imgPos.y;

            //console.log("Find Obj: ",itemTitle[i]);
            //console.log("title pos", titlePos);
            ...
            if(moveX<maxDisX && moveY<maxDisY){
                //console.log("YESS Your node "+slaveNode+" text is  = ",jq.trim(jq(itemTitle[i]).text()));
                return (jq.trim(jq(itemTitle[i]).text()));
                break;
            }
            else{
               //console.log("i didn't find close object", itemTitle[i])
            }
        }
        return "";
    },
    ...
    getRelText : function(node){
        ...
        if (node) {
            ...
            //console.log("compare to this link:",links);
            var lNode = links[0];
            if (lNode) {
                var url = lNode.href;
